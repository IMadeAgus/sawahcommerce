    ...
    <div class="max-w-2xl mx-auto mt-10 bg-white rounded-xl shadow-md p-6">
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input name="price" id="inputPrice" type="number" min="0"
            ...
            <div>
                ...
                <select name="category_id" id="inputCategory" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('category') border-red-500 @enderror">
            ...
            <div>
                ...
                <input type="file" name="image" id="inputImage"
                    class="mt-1 block w-full text-sm text-gray-900 border border-gray-300 rounded-md file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-100 file:text-blue-700 hover:file:bg-blue-200 @error('image') border-red-500 @enderror">
                @error('image')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
